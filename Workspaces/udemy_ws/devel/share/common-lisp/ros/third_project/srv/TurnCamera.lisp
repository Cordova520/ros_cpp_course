...
(cl:in-package third_project-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <TurnCamera-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCamera-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name third_project-srv:<TurnCamera-request> is deprecated: use third_project-srv:TurnCamera-request instead.")))

(cl:ensure-generic-function 'deg_turn-val :lambda-list '(m))
(cl:defmethod deg_turn-val ((m <TurnCamera-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader third_project-srv:deg_turn-val is deprecated.  Use third_project-srv:deg_turn instead.")
  (deg_turn m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurnCamera-request>)))
  ...
  "third_project/TurnCameraRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurnCamera-request)))
  "Returns string type for a service object of type 'TurnCamera-request"
  "third_project/TurnCameraRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TurnCamera-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCamera-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name third_project-srv:<TurnCamera-response> is deprecated: use third_project-srv:TurnCamera-response instead.")))

(cl:ensure-generic-function 'camera_image-val :lambda-list '(m))
(cl:defmethod camera_image-val ((m <TurnCamera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader third_project-srv:camera_image-val is deprecated.  Use third_project-srv:camera_image instead.")
  (camera_image m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurnCamera-response>)))
  ...
  "third_project/TurnCameraResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurnCamera-response)))
  "Returns string type for a service object of type 'TurnCamera-response"
  "third_project/TurnCameraResponse")
