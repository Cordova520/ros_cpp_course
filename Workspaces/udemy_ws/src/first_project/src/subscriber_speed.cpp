...
const float WHEEL_RADIUS = 12.5/100; //Size in centimiters --> meters
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber speed_sub = node_handle.subscribe("rpm", 10, subCallback);
